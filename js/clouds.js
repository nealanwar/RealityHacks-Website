...
var Base, Particle, canvas, colorPrimary, colorSecondary, colorTertiary, colors, context, draw, drawables, i, mouseX, mouseY, mouseVX, mouseVY, rand, update, click, min, max, colors, particles;

min = 3;
max = 4;
particles = 100;
colorPrimary = "75, 156, 211";
colorSecondary = "0, 0, 200, .5";
colorTertiary = "0, 255, 255";
...
var generator = Math.floor((Math.random()*colors.length));
this.color = colors[generator];
